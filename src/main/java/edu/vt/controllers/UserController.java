/*
 * Created by Osman Balci on 2021.12.22
...
public class UserController implements Serializable {
    ...
    public String getSelectedSecurityQuestion() {
        System.out.println("Security Question: " + selectedSecurityQuestion);
    ...
    ***************************************
    ...
    public String userPhotoById(User uID) {
        ...
        List<UserPhoto> photoList = userPhotoFacade.findPhotosByUserPrimaryKey(uID.getId());
        if (photoList.isEmpty()) {
            // No user photo exists. Return defaultUserPhoto.png.
            return Constants.PHOTOS_URI + "defaultUserPhoto.png";
        }
    ...
    ********************************************************
    ...
    public Boolean isAdmin() {
        ...
        return getSignedInUser().getUsername().equals("Administrator");
    }
