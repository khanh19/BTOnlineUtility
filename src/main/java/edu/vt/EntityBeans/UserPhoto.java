...
// The @Entity annotation designates this class as a JPA Entity POJO class representing the database table UserPhoto.
@Entity
...
public class UserPhoto implements Serializable {
    ...
    /*
    ==========================================================
    Class constructors for instantiating a UserPhoto entity
    object to represent a row in the database table UserPhoto.
    ==========================================================
     */
    public UserPhoto() {
    }
    ...
    /*
    User's photo image file is named as "userId.fileExtension", e.g., 5.jpeg for user with id 5.
