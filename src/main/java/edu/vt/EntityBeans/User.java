...
@NamedQueries({
        ...
        , @NamedQuery(name = "User.findByTwoFaStatus", query = "SELECT u FROM User u WHERE u.twoFactorAuthenticationStatus = :twoFaStatus")
...
public class User implements Serializable {
    ...
    public int getTwoFactorAuthenticationStatus() {
        return twoFactorAuthenticationStatus;
    }

    public void setTwoFactorAuthenticationStatus(int twoFactorAuthenticationStatus) {
